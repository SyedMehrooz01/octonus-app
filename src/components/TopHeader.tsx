    ...
    <header className="sticky top-0 z-10 flex h-14 items-center justify-between border-b border-border bg-card px-4 md:px-6">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-3 md:hidden">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary">
            <span className="text-xs font-bold text-primary-foreground">{BRAND_INITIALS}</span>
          </div>
          <span className="text-sm font-bold text-primary">{BRAND_NAME}</span>
        </div>
      ...
      <div className="flex items-center gap-3">
        ...
        {onLogout && (
          <button
            onClick={onLogout}
            className="hidden md:flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground hover:bg-muted hover:text-destructive"
            title="Logout"
          >
